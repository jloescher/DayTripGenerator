...
def random_destination():
    random_number = random.randint(0, len(destinations))
...
def destination_sequence():
    ...
    destination_confirm = input(
        f"Are you happy with {session_destination} as your destination or would you like to choose another destination? Y or N: "
    )
